...
public class Principal {
    ...
    private final String API_KEY = "&apikey=8f3dba8f";
...
//        DatosSerie datosSerie = getDatosSerie();
        mostrarSeriesBuscadas();
        System.out.println("Escribe el nombre de la serie de la cual quieres " +
                "ver los episodios");
        var nombreSerie = teclado.nextLine();
...
//                .map(d -> new Serie(d))
//                .collect(Collectors.toList());
        series = repositorio.findAll(); //Trae todas las lista
    ...
    private void buscarSeriesPorCategoria() {
        System.out.println("Escriba el género/Categoría de la serie" +
                " que desea buscar");
...
//        List<Serie> filtroSeries = repositorio.findByTotalTemporadasLessThanEqualAndEvaluacionGreaterThanEqual(totalTemporadas, evaluacion);
        ...
        filtroSeries.forEach(s ->
                System.out.println(s.getTitulo() + " - evaluación: " +
                        s.getEvaluacion()));
    }

    private void buscarEpisodiosPorTitulo() {
        System.out.println("Escriba el nombre del episodio a buscar:");
...
//        episodiosEncontrados.forEach(e -> System.out.println(e.getTitulo()));
    }
